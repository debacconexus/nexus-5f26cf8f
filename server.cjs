...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Supply Chain Management Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Supply Chain Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "supply_chain_record_records";
'use strict';
